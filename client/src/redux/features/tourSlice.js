...
const tourSlice = createSlice({
    ...
    extraReducers: {
        [createTour.pending]: (state, action) => { state.loading = true; },
        ...
        [getTours.pending]: (state, action) => { state.loading = true; },
        ...
        [getTour.pending]: (state, action) => { state.loading = true; },
        ...
        [getToursByUser.pending]: (state, action) => { state.loading = true; },
        ...
        [deleteTour.pending]: (state, action) => { state.loading = true; },
        ...
        [updateTour.pending]: (state, action) => { state.loading = true; },
        ...
        [likeTour.rejected]: (state, action) => { state.error = action.payload.message; },
        ...
        [getToursByTag.pending]: (state, action) => { state.loading = true; },
        ...
        [getRelatedTours.pending]: (state, action) => { state.loading = true; },
